...
- Stage card shape (locked): small icon + cluster TITLE on its own full-width row + the chips + "see how ->" pushed to the bottom. NO one-line lead / description under the title. The title must say it all. If a card needs a lead to make sense, the title is too weak: rewrite the title.
